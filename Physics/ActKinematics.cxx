...
ActPhysics::Kinematics::Kinematics(double m1, double m2, double m3, double m4,
                                   double T1,
                                   double Eex)
...
double ActPhysics::Kinematics::ComputeMissingMass(double argT3, double argTheta3LabRads, double argPhi3Rads, double Tbeam,
